...
declare module '$env/static/private' {
	...
	export const K2PDFOPT_CUSTOM0: string;
	export const K2PDFOPT_CUSTOM1: string;
	export const K2PDFOPT_CUSTOM2: string;
	export const K2PDFOPT_WINPOS: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		INFOPATH: string;
		INIT_CWD: string;
		K2PDFOPT_CUSTOM0: string;
		K2PDFOPT_CUSTOM1: string;
		K2PDFOPT_CUSTOM2: string;
		K2PDFOPT_WINPOS: string;
		LANG: string;
		LOCALAPPDATA: string;
		LOGONSERVER: string;
		MANPATH: string;
