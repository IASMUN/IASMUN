import { a1 as head } from "../../../../chunks/index.js";
import { S as Saos } from "../../../../chunks/Saos.js";
function _page($$payload) {
  head($$payload, ($$payload2) => {
    $$payload2.title = `<title>About Us</title>`;
    $$payload2.out += `<meta name="description" content="The Mission, Vision, and History of IASMUN">`;
  });
  $$payload.out += `<div class="about svelte-4ivkys"><div class="container mission svelte-4ivkys">`;
  Saos($$payload, {
    once: true,
    animation: "slide-bottom 1.5s cubic-bezier(0.250, 0.460, 0.450, 0.940) both;",
    children: ($$payload2) => {
      $$payload2.out += `<h1 class="svelte-4ivkys">Mission</h1>`;
    },
    $$slots: { default: true }
  });
  $$payload.out += `<!----> `;
  Saos($$payload, {
    ...
    children: ($$payload2) => {
      $$payload2.out += `<p class="svelte-4ivkys">At IAS Model United Nations, our mission is to cultivate an enriching experience where every participant has the
			    ...
			    global citizens. <br> <br> We strive to create a diverse, inclusive, and intellectually stimulating environment, where people from all backgrounds
			    ...
			    understanding and addressing pressing international issues.</p>`;
    },
    $$slots: { default: true }
  });
  $$payload.out += `<!----></div> <div class="container vision svelte-4ivkys">`;
  Saos($$payload, {
    once: true,
    animation: "slide-bottom 1.5s cubic-bezier(0.250, 0.460, 0.450, 0.940) both;",
    children: ($$payload2) => {
      $$payload2.out += `<h1 class="svelte-4ivkys">Vision</h1>`;
    },
    $$slots: { default: true }
  });
  $$payload.out += `<!----> `;
  Saos($$payload, {
    ...
    animation: "fade-in 1.5s cubic-bezier(0.390, 0.575, 0.565, 1.000) both",
    children: ($$payload2) => {
      $$payload2.out += `<p class="svelte-4ivkys">Our vision is that each participant leaves the conference with something valuable—whether it be new friends, essential 
			    ...
			    beyond the conference, as they continue to grow and contribute to the world around them.</p>`;
    },
    $$slots: { default: true }
  });
  $$payload.out += `<!----></div> <div class="container history svelte-4ivkys">`;
  Saos($$payload, {
    once: true,
    animation: "slide-bottom 1.5s cubic-bezier(0.250, 0.460, 0.450, 0.940) both;",
    children: ($$payload2) => {
      $$payload2.out += `<h1 class="svelte-4ivkys">History</h1>`;
    },
    $$slots: { default: true }
  });
  $$payload.out += `<!----> `;
  Saos($$payload, {
    ...
    animation: "fade-in 1.5s cubic-bezier(0.390, 0.575, 0.565, 1.000) both",
    children: ($$payload2) => {
      $$payload2.out += `<p class="svelte-4ivkys">In the fall of 2023, a group of passionate seniors founded the International Academic School Model United Nations
			    ...
			    shape IASMUN's legacy. <br> <br> Guided by the insights of these founders, the 2024 seniors took IASMUN to new heights in its second edition in January
			    ...
			    MUN conference. <br> <br> Now, as IASMUN moves into its third edition in 2025, under the dedicated leadership of current juniors and seniors, the
			    ...
			    inspiring the next generation of leaders.</p>`;
    },
    $$slots: { default: true }
  });
  $$payload.out += `<!----></div></div>`;
