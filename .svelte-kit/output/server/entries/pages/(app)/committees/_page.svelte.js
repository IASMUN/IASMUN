...
const GA1CHAIR = "/iasmun/_app/immutable/assets/Daniyal%20Ali.BaIe-9cf.webp";
const GA1COCHAIR = "/iasmun/_app/immutable/assets/Ceyra%20Jackson.D05qzMHq.webp";
const GA2CHAIR = "/iasmun/_app/immutable/assets/Dona%20Shenushi.Defyj5M5.webp";
const GA2COCHAIR = "/iasmun/_app/immutable/assets/Omar%20Mohammed.PPHYUwW7.webp";
const GA3CHAIR = "/iasmun/_app/immutable/assets/Shreya%20Galrani.BGf0N2lZ.webp";
const GA3COCHAIR = "/iasmun/_app/immutable/assets/Taha%20Kamal.Dg4b1dyz.webp";
const UNHRCCHAIR = "/iasmun/_app/immutable/assets/Armin%20Dianat.BYFyaYYo.webp";
const UNHRCCOCHAIR = "/iasmun/_app/immutable/assets/Manaal%20Khan.Cvp4a5GC.webp";
const F1CHAIR = "/iasmun/_app/immutable/assets/Dev%20Dalal.DNttKM8f.webp";
const F1COCHAIR = "/iasmun/_app/immutable/assets/Zeyad%20Usama.DvGAGCu0.webp";
const UNFCCCCHAIR = "/iasmun/_app/immutable/assets/Fahim%20Sulaiman.DDzn1-BO.webp";
const UNFCCCCOCHAIR = "/iasmun/_app/immutable/assets/Kripa%20Gehi.DDbP8BpK.webp";
const UNODCCHAIR = "/iasmun/_app/immutable/assets/Nida%20Gazzali.D5hdCkbP.webp";
const UNODCCOCHAIR = "/iasmun/_app/immutable/assets/Aryesh%20Biswas.CwFCqkh8.webp";
const WHOCHAIR = "/iasmun/_app/immutable/assets/Reem%20Saleem.CFkzLfMn.webp";
const WHOCOCHAIR = "/iasmun/_app/immutable/assets/Shaurya%20Galrani.n9KpiYVj.webp";
const ARABLEAGUECHAIR = "/iasmun/_app/immutable/assets/Laila%20Mohamed.BTbjJzt1.webp";
const ARABLEAGUECOCHAIR = "/iasmun/_app/immutable/assets/Frank%20Toh.DSbC_sml.webp";
const UNICEFCHAIR = "/iasmun/_app/immutable/assets/Fares%20Basil.CaYghDlt.webp";
const UNICEFCOCHAIR = "/iasmun/_app/immutable/assets/Aarav%20Garg.CNLFpN-t.webp";
function _page($$payload) {
  const committees = [
    {
      class: "GA1",
      name: "Disarmament & International Security Committee (GA1)",
      purpose: "GA1 is committed to advancing worldwide peace and security by tackling pressing concerns related to arms regulation, disarmament efforts, and conflict prevention",
      topics: [
      ...
      cochair_letter: `Hello delegates !!, 
                ...
                <br />
                `,
      cochair_photo: GA1COCHAIR,
      cochair_name: " Ceyra Jackson "
    },
    {
      class: "GA2",
      name: "Economic & Financial Committee (GA2)",
      purpose: "GA2 places its emphasis on international economic affairs. Its main efforts are directed towards formulating policies and tactics to strengthen the global economy, diminish poverty, and reinforce financial security.",
      topics: [
      ...
      cochair_letter: `It’s my pleasure to welcome you all to IASMUN25 and to the exciting discussions ahead in the second 
            ...
            that make this experience truly impactful. Lets' make this an unforgettable session!.`,
      cochair_photo: GA2COCHAIR,
      cochair_name: "Omar Mohammed"
    },
    {
      class: "GA3",
      name: "Social, Cultural, & Humanitarian Affairs (GA3)",
      purpose: " GA3 is all about humanity. This committee addresses social and humanitarian challenges worldwide, from healthcare and education to culture and sustainable development. Delegates collaborate to make the world a better place for all.",
      topics: [
        " Climate-Induced Migration: Protecting the Rights of Displaced Populations.",
        " Cultural Preservation in the Age of Globalization: Safeguarding Heritage and Diversity."
      ],
      chair_letter: `Hello everyone my name is Shreya Galrani and I’ll be your Head Chair for General Assembly 3 committee IASMUN 2024.
             ...
             something fun about the agenda (or how to have amazing moves in socials) Regards,Shreya Galrani.`,
      chair_photo: GA3CHAIR,
      chair_name: "Shreya Galrani",
      cochair_letter: `Hello, Delegates! I'm Taha Kamal an Egyptian and your co-chair in the GA3 committee at IASMUN 25'.
             ...
             this conference a beneficial experience of growth. Best of luck delegates. `,
    ...
    },
    {
      ...
      purpose: " UNHRC is dedicated to protecting and promoting human rights globally. This committee addresses violations, fosters accountability, and works toward justice and equality for all individuals.",
      topics: [
        " Ensuring Access to Justice for marginalized communities: Overcoming barriers to legal representation.",
        " Freedom of speech VS hate speech: Balancing human rights in the modern era."
      ],
      chair_letter: `DELEGATES! DELEGATES! DELEGATES! my name is Armin Dianat and I am the head chair of UNHRC (the best committee). Words can't describe how delighted I am to be in this position, I am so excited to witness all the lively debates and drama in this committee.
    ...
    },
    {
      ...
      purpose: " UNFCCC focuses on combating climate change and its global impacts. This committee promotes sustainable solutions, international cooperation, and resilience for a greener future.",
      topics: [
        "Addressing Climate Justice: Implementing climate reparations for historical Polluters",
        " Global carbon Market: Ensuring Fair and Effective Carbon Trading Systems"
      ],
      chair_letter: `Hi delegates,
            <br /><br />
    ...
    },
    {
      ...
      purpose: "UNODC is the United Nations' front line against drugs and crime. They work to combat drug trafficking, corruption, human trafficking, and other global crimes.",
      topics: [
        "Strengthening Global Legal Frameworks to Combat Human Traﬃcking.",
        "The Role of Technology in Combating Drug Traﬃcking and Organized Crime."
      ],
      chair_letter: `Hey delegates,
            <br /><br />
...
I have always had a passion for debating, and I assure each and every one of you, whether you’re experienced or not, you will have a lot to take away from this conference, and most importantly, have an amazing time! Looking forward to meeting each and everyone of you!`,
    ...
    },
    {
      ...
      purpose: "WHO is the global guardian of public health. They lead international efforts to prevent epidemics, ensure access to quality healthcare, and promote health for all.",
      topics: [
        " Mental Health Crisis: Addressing the Silent Epidemic in Marginalized Populations",
        "Health Technology Access in Remote and Underserved Regions"
      ],
      chair_letter: `Greetings delegates! I am Reem Saleem, chairing for the World Health Organization Committee. May this conference bring out the best in your debating skills and hopefully create special memories. Best of luck!

            <br /><br />
            Sincerely Reem`,
      chair_photo: WHOCHAIR,
      chair_name: "Reem Saleem",
      cochair_letter: `Dear delegates,
            ...
            Best Regards,
            <br /><br />
            Shaurya Shiva Galrani`,
      cochair_photo: WHOCOCHAIR,
      cochair_name: "Shaurya Galrani"
    },
    {
      class: "arab-league",
      name: "Arab League (EN)",
      purpose: "The Arab League is an organization dedicated to promoting cooperation and coordination among Arab nations. Their work spans various areas, including politics, economics, culture, and social issues, all with a focus on advancing the interests of Arab states.",
      topics: [
        "Combating Gender-Based Violence: Strategies for Protecing Women’s Rights in the Arab World.",
        "Sustainable Urban Development: Planning Smart Cities in the Arab World."
      ],
      chair_letter: `
            <br /><br />
    ...
    {
      class: "Formula 1 Committee (F1)",
      name: "Formula 1 Committee (F1)",
      purpose: "The F1 committee delves into global financial and economic challenges. It aims to foster cooperation, stabilize economies, and drive sustainable development through innovative solutions ",
      topics: [
        "Advancing Diversity in Formula 1: Overcoming Barriers in Race, Gender, and Culture.",
        " Technological Innovations in F1: Balancing Performance, Safety, and Environmental Impact."
      ],
      chair_letter: `
            <br /><br />
            Dear Delegates,
    ...
    },
    {
      ...
      purpose: "UNICEF is all about children's well-being. They provide humanitarian aid, health care, and education to children in need around the world. Their mission is to ensure every child has the opportunity to grow up healthy, educated, and safe.",
      topics: [
        " Youth Unemployment Crisis: Creating Sustainable Opportunities for Future Generations",
        " Reducing Violence Against Children in Low-Income Communities"
      ],
      chair_letter: `Hello delegates, I am Fares Basil, your family-friendly chair for UNICEF in this edition’s IASMUN’25. I am excited to see ambitious debates, meaningful discussions, and heart touching resolutions, good luck`,
      chair_photo: UNICEFCHAIR,
      chair_name: "Fares Basil",
      cochair_letter: `Greetings esteemed delegates
      ...
      cochair_photo: UNICEFCOCHAIR,
      cochair_name: "Aarav Garg"
    }
  ];
  const each_array_1 = ensure_array_like(committees);
  head($$payload, ($$payload2) => {
    $$payload2.title = `<title>Committees</title>`;
    $$payload2.out += `<meta name="description" content="Introduction to The 9 Committees of IASMUN, along with their topics, purpose, and their dais" class="svelte-1hmngc5">`;
  });
  $$payload.out += `<h1 class="header svelte-1hmngc5">Committees</h1> `;
  Saos($$payload, {
    once: true,
    animation: "slide-top-qaccess 0.8s cubic-bezier(0.250, 0.460, 0.450, 0.940) both",
    children: ($$payload2) => {
      const each_array = ensure_array_like(committees);
      $$payload2.out += `<div class="quickaccess svelte-1hmngc5"><!--[-->`;
      for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
        let committee = each_array[$$index];
        $$payload2.out += `<a class="quickaccess-links svelte-1hmngc5"${attr("href", `#${committee.class}`)}>${escape_html(committee.class == "arab-league" ? "AL (EN)" : committee.class)}</a>`;
      }
      $$payload2.out += `<!--]--></div>`;
    },
    $$slots: { default: true }
  });
  $$payload.out += `<!----> <div class="committees svelte-1hmngc5"><!--[-->`;
  for (let $$index_2 = 0, $$length = each_array_1.length; $$index_2 < $$length; $$index_2++) {
    let committee = each_array_1[$$index_2];
    const each_array_2 = ensure_array_like(committee.topics);
    $$payload.out += `<div${attr("class", `${stringify(`committee ${committee.class}`)} svelte-1hmngc5`)}${attr("id", committee.class)}><div class="committee-header svelte-1hmngc5">`;
    Saos($$payload, {
      once: true,
      animation: "slide-bottom 0.8s cubic-bezier(0.250, 0.460, 0.450, 0.940) both",
      children: ($$payload2) => {
        $$payload2.out += `<h1 class="svelte-1hmngc5">${escape_html(committee.name)}</h1>`;
      },
      $$slots: { default: true }
    });
    $$payload.out += `<!----></div> <div class="purpose svelte-1hmngc5"><h2 class="subheader svelte-1hmngc5">Purpose</h2> <p class="desc svelte-1hmngc5">${escape_html(committee.purpose)}</p></div> <h2 class="subheader topics-header svelte-1hmngc5">Topics</h2> <ol class="topics svelte-1hmngc5"><!--[-->`;
    for (let $$index_1 = 0, $$length2 = each_array_2.length; $$index_1 < $$length2; $$index_1++) {
      let topic = each_array_2[$$index_1];
      $$payload.out += `<li class="svelte-1hmngc5">${escape_html(topic)}</li>`;
    }
    $$payload.out += `<!--]--></ol> <div class="letters svelte-1hmngc5"><div class="chair svelte-1hmngc5"><h2 class="subheader svelte-1hmngc5">Chair's Letter</h2> <div class="content svelte-1hmngc5">`;
    Saos($$payload, {
      once: true,
      animation: "slide-right-letter 0.8s cubic-bezier(0.250, 0.460, 0.450, 0.940) both;",
      children: ($$payload2) => {
        $$payload2.out += `<p class="svelte-1hmngc5">${html(committee.chair_letter)}</p>`;
      },
      $$slots: { default: true }
    });
    $$payload.out += `<!----> `;
    Saos($$payload, {
      ...
      children: ($$payload2) => {
        $$payload2.out += `<div class="dais svelte-1hmngc5"><img class="img svelte-1hmngc5"${attr("src", committee.chair_photo)}${attr("alt", committee.chair_name)}> <p class="dais-name svelte-1hmngc5">${escape_html(committee.chair_name)}</p></div>`;
      },
      $$slots: { default: true }
    });
    $$payload.out += `<!----></div></div> `;
    if (committee.cochair_name !== void 0) {
      $$payload.out += "<!--[-->";
      $$payload.out += `<div class="co-chair svelte-1hmngc5"><h2 class="subheader svelte-1hmngc5">Co-Chair's Letter</h2> <div class="content svelte-1hmngc5">`;
      Saos($$payload, {
        once: true,
        animation: "slide-left-letter 0.8s cubic-bezier(0.250, 0.460, 0.450, 0.940) both;",
        children: ($$payload2) => {
          $$payload2.out += `<p class="svelte-1hmngc5">${html(committee.cochair_letter)}</p>`;
        },
        $$slots: { default: true }
      });
      $$payload.out += `<!----> `;
      Saos($$payload, {
        ...
        animation: "slide-right-letter 0.8s cubic-bezier(0.250, 0.460, 0.450, 0.940) both;",
        children: ($$payload2) => {
          $$payload2.out += `<div class="dais svelte-1hmngc5"><img class="img svelte-1hmngc5"${attr("src", committee.cochair_photo)}${attr("alt", committee.cochair_name)}> <p class="dais-name svelte-1hmngc5">${escape_html(committee.cochair_name)}</p></div>`;
        },
        $$slots: { default: true }
      });
      $$payload.out += `<!----></div></div>`;
