...
<footer>
	<div class="socials">
		<a target="_blank" rel="noreferrer" href="https://www.instagram.com/ias.mun" class="instagram">
...
<style>
	...
	@keyframes -global-footer-slide-left {
		0% {
			-webkit-transform: translateX(100px);
			transform: translateX(100px);
		}
